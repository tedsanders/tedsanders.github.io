...
svg {
    -webkit-transition: all 3600ms cubic-bezier(0.250, 0.460, 0.450, 0.940); 
       -moz-transition: all 3600ms cubic-bezier(0.250, 0.460, 0.450, 0.940); 
         -o-transition: all 3600ms cubic-bezier(0.250, 0.460, 0.450, 0.940); 
            transition: all 3600ms cubic-bezier(0.250, 0.460, 0.450, 0.940); /* constant friction approximation */
  }
